                                ...
                                <table class="table table-striped" id="table_kelas">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('kelas.edit', $data->id_kelas)}}" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                                                <a href="{{route('kelas.destroy', $data->id_kelas)}}" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus ?')"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        @empty
                                        <tr>
